...
4. Production market data should use `MARKET_DATA_PROVIDER=twelve_data` with `TWELVE_DATA_API_KEY` configured and `MARKET_DATA_FALLBACK_PROVIDERS=stooq` as the explicit fallback chain.
