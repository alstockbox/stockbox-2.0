...
-- Active mark-to-market valuations may use fresh current observations. Exact
-- competition ends_at is reserved for the historical final-valuation pipeline,
-- so an active valuation can never advance the shared verified pointer to the
-- immutable final cutoff.
