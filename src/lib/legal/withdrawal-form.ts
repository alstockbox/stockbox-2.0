...
export function withdrawalFormText(seller: LegalSeller, locale: "en" | "sv") {
  ...
  if (locale === "sv") {
    return [
      ...
      "",
      `Till: ${trader || "StockBox kontaktuppgifter lämnas innan ett betalt abonnemang erbjuds"}`,
      "",
  ...
  return [
    ...
    "",
    `To: ${trader || "StockBox contact details are provided before a paid subscription is offered"}`,
    "",
