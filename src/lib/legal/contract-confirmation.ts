...
export function contractConfirmationText(input: ContractConfirmationInput) {
  ...
  if (sv) {
    return [
      ...
      "",
      "TJÄNST OCH LEVERANS",
      "StockBox är en webbaserad digital analystjänst för aktier. Åtkomst till vald plan aktiveras online efter godkänd betalning.",
  ...
  return [
    ...
    "StockBox is a web-based digital equity research service. Access to the selected plan is activated online after successful payment.",
