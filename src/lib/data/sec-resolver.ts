...
export const SEC_CONCEPTS = {
  ...
  grossLoans: { kind: "instant", units: ["USD"], aliases: [us("LoansAndLeasesReceivableGrossCarryingAmount"), us("FinancingReceivableExcludingAccruedInterestBeforeAllowanceForCreditLoss"), us("FinancingReceivableBeforeAllowanceForCreditLossAndFee"), us("LoansAndLeasesReceivableNetOfDeferredIncome"), us("LoansAndLeasesReceivableNetReportedAmount")] },
  deposits: { kind: "instant", units: ["USD"], aliases: [us("Deposits")] },
  nonInterestIncome: { kind: "duration", units: ["USD"], aliases: [us("NoninterestIncome")] },
  nonInterestExpense: { kind: "duration", units: ["USD"], aliases: [us("NoninterestExpense")] },
  loanLossProvisions: { kind: "duration", units: ["USD"], aliases: [us("ProvisionForLoanLeaseAndOtherLosses"), us("ProvisionForLoanLossesExpensed"), us("ProvisionForLoanAndLeaseLosses"), us("FinancingReceivableExcludingAccruedInterestCreditLossExpenseReversal"), us("AllowanceForLoanAndLeaseLossesProvisionForLossNet"), us("AllowanceForLoanAndLeaseLossesProvisionForLossGross"), us("FinancingReceivableAllowanceForCreditLossesProvisions")] },
  nonPerformingLoans: { kind: "instant", units: ["USD"], aliases: [us("FinancingReceivableExcludingAccruedInterestNonaccrual"), us("FinancingReceivableRecordedInvestmentNonaccrualStatus"), us("FinancingReceivableNonaccrualNoAllowance"), us("LoansAndLeasesReceivableImpairedNonperformingNonaccrualOfInterest")] },
  pastDueLoansStillAccruing: { kind: "instant", units: ["USD"], aliases: [us("FinancingReceivableRecordedInvestment90DaysPastDueAndStillAccruing")] },
  netChargeOffs: { kind: "duration", units: ["USD"], aliases: [us("FinancingReceivableExcludingAccruedInterestAllowanceForCreditLossWriteoffAfterRecovery"), us("FinancingReceivableAllowanceForCreditLossWriteoffAfterRecovery"), us("AllowanceForLoanAndLeaseLossesWriteoffsNet")] },
  grossChargeOffs: { kind: "duration", units: ["USD"], aliases: [us("FinancingReceivableExcludingAccruedInterestAllowanceForCreditLossWriteoff"), us("FinancingReceivableAllowanceForCreditLossesWriteOffs"), us("AllowanceForLoanAndLeaseLossesWriteOffs")] },
  chargeOffRecoveries: { kind: "duration", units: ["USD"], aliases: [us("FinancingReceivableExcludingAccruedInterestAllowanceForCreditLossRecovery"), us("FinancingReceivableAllowanceForCreditLossesRecovery"), us("AllowanceForLoanAndLeaseLossRecoveryOfBadDebts")] },
  goodwill: { kind: "instant", units: ["USD"], aliases: [us("Goodwill")] },
  intangibleAssetsExcludingGoodwill: { kind: "instant", units: ["USD"], aliases: [us("IntangibleAssetsNetExcludingGoodwill"), us("FiniteLivedIntangibleAssetsNet"), us("IndefiniteLivedIntangibleAssetsExcludingGoodwill"), us("OtherIntangibleAssetsNet")] },
