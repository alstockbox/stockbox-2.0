...
import type { InvestmentCompanyDividendQualityYear } from "./investment-company-dividend-quality";
...
const LUNDBERGS_DIVIDEND_HISTORY: InvestmentCompanyDividendQualityYear[] = [
...
export type OfficialInvestmentCompanyDividendHistoryData = {
  years: InvestmentCompanyDividendQualityYear[];
