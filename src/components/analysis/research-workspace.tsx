...
export async function AnalysisResearchWorkspace({ticker,analysisId}:{ticker:string;analysisId:string}){
  ...
  const thesisHref = `/thesis/${encodeURIComponent(ticker)}` as Route;
