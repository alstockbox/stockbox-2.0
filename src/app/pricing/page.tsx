...
function PlanAction({
  ...
  if (action.kind === "checkout") {
    return <CheckoutButton plan={plan} enabled={checkoutEnabled} label={label} pendingLabel={billingCopy.openingCheckout} fallbackError={billingCopy.checkoutError} locale={locale} />;
  }
