...
export default function PeRatioPage() {
  ...
  const breadcrumbs = [{ label: "StockBox", href: "/" }, { label: "Nyckeltal", href: "/nyckeltal" }, { label: "P/E-tal", href: "/nyckeltal/pe-tal" }];
  return <>
