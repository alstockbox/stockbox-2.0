      ...
      <Section id="research" className="py-12 sm:py-16">
        <Container>
          <div className="mb-7 flex flex-wrap items-end justify-between gap-4">
            ...
            <p className="flex max-w-md items-start gap-2 text-sm leading-6 text-[#9aa7b8]"><CheckCircle2 className="mt-1 h-4 w-4 shrink-0 text-emerald-300" aria-hidden="true" />No fabricated financial data. Missing provider setup is shown honestly.</p>
          </div>
