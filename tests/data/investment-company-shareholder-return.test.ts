...
describe("investment-company shareholder return math", () => {
  it("derives 3Y and 5Y CAGR only from verified adjusted-close observations", () => {
  ...
  it("accepts a latest adjusted-close observation exactly 45 days before the market date", () => {
    const result = deriveInvestmentCompanyShareholderReturns([
