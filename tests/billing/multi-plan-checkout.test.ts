...
describe("multi-plan checkout", () => {
  beforeEach(() => {
    ...
    mocks.getBillingReadiness.mockReturnValue({ checkoutReady: true, supabaseConfigured: true, restrictedKeyPresent: true, basicPricePresent: true, launchCouponPresent: true, paidCatalogReady: true, missingVariables: [] });
